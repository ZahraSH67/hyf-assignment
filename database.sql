...
-- Assuming "valid" means the due_date is NULL or not a proper date
SELECT COUNT(*) AS tasks_without_valid_due_date 
FROM task 
WHERE due_date IS NULL;

-- 3. Find all the tasks that are marked as done.
-- Assuming status_id refers to a status table where "done" is the name
